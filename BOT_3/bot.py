...
with tf.Session() as sess:
    ...
    while episode_number <= total_episodes:
        ...
        if np.random.uniform() < tfprob[0][0]:
            action = 0                          #buy
        elif np.random.uniform() < tfprob[0][0]:
            action = 1                          #sell
        else:
            action = 2                          #hold
        ...
        if done:
            ...
            if episode_number % 50 == 0:
                ...
                plt.savefig("training/BOT_3/trial_6/episode"+str(episode_number)+".png")
                plt.close()
